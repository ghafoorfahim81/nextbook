...
class ExpenseResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'bank_account' => $this->transaction?->lines?->firstWhere(fn($line) => $line->credit > 0)?->account,
            'expense_account_id' => $this->transaction?->lines?->firstWhere(fn($line) => $line->debit > 0)?->account_id,
            'expense_account' => $this->transaction?->lines?->firstWhere(fn($line) => $line->debit > 0)?->account,
