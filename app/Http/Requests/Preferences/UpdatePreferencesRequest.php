    ...
    class UpdatePreferencesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Container material: opaque tokens, or the translucent glass style.
            'appearance.surface_style' => 'sometimes|in:solid,glass',
            ...
            'notifications.low_item_balance_alert' => 'sometimes|boolean',
            'notifications.nearest_expiry_alert' => 'sometimes|boolean',
            'notifications.overdue_purchase_alert' => 'sometimes|boolean',
            'notifications.overdue_sale_alert' => 'sometimes|boolean',
            'notifications.overdue_invoice_alert' => 'sometimes|boolean',
            'notifications.sale_paid_alert' => 'sometimes|boolean',
            'notifications.purchase_paid_alert' => 'sometimes|boolean',
