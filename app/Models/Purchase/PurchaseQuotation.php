...
class PurchaseQuotation extends Model
{
    ...
    {
        return 'You cannot delete this purchase quotation because it has dependencies.';
    }

    public function quotationTotal(): float
    {
        $amount = $this->items->sum(function (PurchaseQuotationItem $item) {
    ...
    {
        return $this->status === PurchaseQuotationStatus::DRAFT->value;
    }

    public function isPosted(): bool
    {
        return $this->status === PurchaseQuotationStatus::POSTED->value;
    }

    public function isCancelled(): bool
    {
        return $this->status === PurchaseQuotationStatus::CANCELLED->value;
    }
}
