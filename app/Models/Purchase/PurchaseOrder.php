...
class PurchaseOrder extends Model
{
    ...
    {
        $orderAmount = $this->items->sum(function (PurchaseOrderItem $item) {
    ...
    {
        return $this->status === PurchaseOrderStatus::DRAFT->value;
    }

    public function isPosted(): bool
    {
        return $this->status === PurchaseOrderStatus::POSTED->value;
    }

    public function isCompleted(): bool
    {
        return $this->status === PurchaseOrderStatus::COMPLETED->value;
    }
