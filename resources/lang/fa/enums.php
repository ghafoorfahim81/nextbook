...
return [
    ...
    'business_type' => [
        ...
        'accounting' => 'شرکت حسابداری و خدماتی',
        'automobile' => 'موتر و پرزه‌جات',
        'book' => 'کتاب‌فروشی / ناشر',
        'clothing' => 'پوشاک (بر اساس سایز)',
        'hotel' => 'هوتل و ریزورت',
        'carpet' => 'قالین و کفپوش (فوت/متر)',
        'electronics' => 'فروشگاه لوازم الکترونیکی',
        'computer' => 'فروشگاه کمپیوتر',
        'jewellery' => 'جواهرفروشی',
        'mobile' => 'موبایل‌فروشی',
        'pharma_manufacturing' => 'تولید دارو (بچ)',
        'ply_carpet' => 'پلایوود و قالین (فوت/متر)',
        'restaurant' => 'رستورانت (بر اساس میز)',
    ],
    'locale' => [
        'fa' => 'فارسی',
        'en' => 'انگلیسی',
    ...
    'costing_method' => [
        'fifo' => 'اولین ورود اولین خروج (FIFO)',
        'lifo' => 'آخرین ورود اولین خروج (LIFO)',
        'weighted_average' => 'میانگین وزنی (WA)',
        'specific' => 'شناسایی مشخص (SP)',
    ],
    'pricing_method' => [
        'fixed' => 'قیمت ثابت',
        'weight_based' => 'بر اساس وزن',
        'area_based' => 'بر اساس مساحت',
        'length_based' => 'بر اساس طول',
    ],
    'payment_mode' => [
