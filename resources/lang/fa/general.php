...
return [
    ...
    'posted_successfully' => ':resource با موفقیت ثبت شد.',
    'reversed_successfully' => ':resource با موفقیت معکوس شد.',
    'only_draft_can_be_posted' => 'فقط پیش‌نویس‌ها می‌توانند ثبت شوند.',
    'only_posted_can_be_reversed' => 'فقط ثبت‌شده‌ها می‌توانند معکوس شوند.',
    'only_draft_can_be_edited' => 'فقط پیش‌نویس‌ها می‌توانند ویرایش شوند.',
    'only_draft_can_be_deleted' => 'فقط پیش‌نویس‌ها می‌توانند حذف شوند.',
    ...
    'post' => 'ثبت',
    'reverse' => 'معکوس',
    'confirm_post' => 'آیا مطمئن هستید که می‌خواهید این رکورد را ثبت کنید؟ این عمل قابل بازگشت نیست.',
    'reverse_confirmation' => 'تأیید معکوس',
    'reverse_confirmation_desc' => 'این عمل یک ورودی جبرانی برای ابطال این رکورد ایجاد می‌کند. لطفاً دلیل را وارد کنید.',
    'reverse_reason_placeholder' => 'دلیل معکوس را وارد کنید...',
];
