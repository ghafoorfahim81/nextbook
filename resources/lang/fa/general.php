...
return [
    'resource' => [
        ...
        'purchase_quotation' => 'پیش‌فاکتور خرید',
        'purchase_return' => 'برگشت خرید',
        'receipt' => 'رسید',
        'role' => 'نقش',
        'sale' => 'فروش',
        'sale_order' => 'سفارش فروش',
        'sale_quotation' => 'پیش‌فاکتور فروش',
    ...
    'prices_updated' => 'قیمت :count قلم به روز شد.',
    ...
    'cannot_reverse_document_with_payments' => 'رسید یا پرداخت :numbers روی این سند تخصیص یافته است. اول آن را باطل کنید، وگرنه پول روی سندی تخصیص‌یافته می‌ماند که دیگر وجود ندارد.',
    'cannot_reverse_document_with_returns' => 'برگشت :numbers روی این سند ثبت شده است. اول آن را باطل یا حذف کنید، وگرنه یک برگشت روی سندی می‌ماند که دیگر وجود ندارد.',
    'cannot_reverse_stock_already_gone' => 'این سند باطل نمی‌شود: جنسی که وارد کرده بود دیگر در انبار نیست. اول اسنادی را که آن را خارج کرده‌اند باطل کنید، یا برای باقی‌مانده برگشت ثبت کنید.',
    'cannot_post_insufficient_stock' => 'ثبت ناممکن است: موجودی کافی برای :item وجود ندارد. ممکن است در فاکتور دیگری فروخته شده باشد.',
    'transfer_cost_accounts_missing' => 'ثبت هزینه انتقال ناممکن است: حساب بانکی یا حساب هزینه انتقال جنس برای این شعبه تنظیم نشده است.',
