            ...
            blocks: [
                {
                    ...
                    rows: [
                        ...
                        ['Inventory', 'Current stock, stock movement, stock value, shortage, batch and expiry, variant-wise, fast/slow movers, zero on hand, maximum stock.'],
                ...
                {
                    type: 'note',
                    label: 'Filtering down to one variant',
                    text: 'Every inventory report, and the item-wise view of the sales and purchase reports, has a Variant filter next to the Item filter. Pick the item first — the variant list then shows only that item’s variants. Leave it empty for the item as a whole.',
                },
            ],
        },
        {
