...
// Reactive copy of the sale_return preferences so the settings panel and form stay in sync.
const userPreferences = computed(() => page.props.user_preferences ?? {});
const returnPrefs = reactive(JSON.parse(JSON.stringify(userPreferences.value?.sale_return ?? {})));
