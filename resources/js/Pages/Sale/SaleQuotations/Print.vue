        ...
        <div class="quotation-sheet">
            ...
            <div class="q-header">
                ...
                <div class="q-title-block">
                    <div class="q-title">{{ t('sale_quotation.sale_quotation') }}</div>
            ...
            <div class="q-meta">
                <div>
                    <div class="q-muted">{{ t('ledger.customer.customer') }}</div>
                    <div class="q-strong">{{ data.customer_name || '-' }}</div>
                </div>
                <div>
                ...
                <div>
                    <div class="q-muted">{{ t('sale_quotation.valid_until') }}</div>
