...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE landed_costs ADD CONSTRAINT landed_costs_allocation_method_check CHECK (allocation_method::text = ANY (ARRAY['by_value'::character varying, 'by_quantity'::character varying, 'by_weight'::character varying, 'by_volume'::character varying, 'equal'::character varying, 'manual'::character varying]::text[]))");
    }
