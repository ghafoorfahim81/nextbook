    ...
    public function run(): void
    {
        ...
        $accounts = [
            ...
            [
                ...
                'number' => 'Ac-201',
                'account_type_id' => AccountType::where('name', 'Accounts Payable')->first()->id,
                'branch_id' => $mainBranch->id,
                'remark' => 'Accounts Payable Account',
            ],
            [
                'name' => 'Accounts Receivable',
                'number' => 'Ac-301',
                'account_type_id' => AccountType::where('name', 'Accounts Receivable')->first()->id,
                'branch_id' => $mainBranch->id,
                'remark' => 'Accounts Receivable Account',
            ],
            [
                'name' => 'Store',
                'number' => 'Ac-401',
