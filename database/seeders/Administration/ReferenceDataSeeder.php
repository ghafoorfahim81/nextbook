...
class ReferenceDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // updateOrCreate / firstOrCreate below are already idempotent — they match
        // on the natural key, so re-running this seeder never duplicates rows.
        ...
        foreach ([
            ['Cash on Delivery', 0, 'immediate'],
            ['Net 7', 7, 'net'],
            ['Net 15', 15, 'net'],
            ['Net 30', 30, 'net'],
            ['Net 60', 60, 'net'],
            ['End of Month', 30, 'end_of_month'],
        ] as [$name, $days, $type]) {
